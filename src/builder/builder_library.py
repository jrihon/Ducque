...
"ptA" : [DH + "json/photna_adenosine_3_4_twist.json", DH + "json/dna_phosphate.json"],
"ptC" : [DH + "json/photna_cytidine_3_4_twist.json", DH + "json/dna_phosphate.json"],
"ptG" : [DH + "json/photna_guanosine_3_4_twist.json", DH + "json/dna_phosphate.json"],
"ptT" : [DH + "json/photna_thymidine_3_4_twist.json", DH + "json/dna_phosphate.json"],
}
...
"ptA" : [DH + "json/photna_adenosine_3_4_twist.json"],
"ptC" : [DH + "json/photna_cytidine_3_4_twist.json"],
"ptG" : [DH + "json/photna_guanosine_3_4_twist.json"],
"ptT" : [DH + "json/photna_thymidine_3_4_twist.json"],
}
